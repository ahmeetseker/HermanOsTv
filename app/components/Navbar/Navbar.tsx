...
const navigation: NavigationItem[] = [
    { name: 'Hakkımızda', href: '#aboutus-section', current: false },
    { name: 'Hizmetler', href: '#services-section', current: false },
    { name: 'S.S.S', href: '#faq-section', current: false },
    { name: 'Referanslar', href: '#testimonial-section', current: false },
]
                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex flex-shrink-0 items-center border-right">
                                <Link href="/" className='text-2xl sm:text-4xl font-semibold text-black  flex items-center justify-center'>
                                    <img className='xs:w-[70px] lg:w-[100px]' src="/images/navbar/LOGOHERMANIPTV.png" alt="" />  
                                     <span>HermanOStv</span> 
                                </Link>
                            </div>
